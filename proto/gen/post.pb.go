...
type PostResponse struct {
	...
	Upvotes []string `protobuf:"bytes,4,rep,name=upvotes,proto3" json:"upvotes,omitempty"`
}
...
func (x *PostUserIdRequest) Reset() {
	*x = PostUserIdRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PostUserIdRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PostUserIdRequest) ProtoMessage() {}

func (x *PostUserIdRequest) ProtoReflect() protoreflect.Message {
	mi := &file_post_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PostUserIdRequest.ProtoReflect.Descriptor instead.
func (*PostUserIdRequest) Descriptor() ([]byte, []int) {
	return file_post_proto_rawDescGZIP(), []int{3}
}

func (x *PostUserIdRequest) GetPostId() string {
	if x != nil {
		return x.PostId
	}
	return ""
...
func (x *PostUserIdRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
var file_post_proto_rawDesc = []byte{
	...
	0x62, 0x6f, 0x64, 0x79, 0x22, 0x62, 0x0a, 0x0c, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x0a, 0x07, 0x75, 0x70, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x07, 0x75, 0x70, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x38, 0x0a, 0x11, 0x4d, 0x61, 0x6e, 0x79,
	0x50, 0x6f, 0x73, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a,
	0x05, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x50,
	0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05, 0x70, 0x6f, 0x73,
	0x74, 0x73, 0x22, 0x47, 0x0a, 0x11, 0x50, 0x6f, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64,
	...
	,
...
var file_post_proto_goTypes = []interface{}{
	...
	(*ManyPostsResponse)(nil), // 2: ManyPostsResponse
	(*PostUserIdRequest)(nil), // 3: PostUserIdRequest
	(*Empty)(nil),             // 4: Empty
}
var file_post_proto_depIdxs = []int32{
	1, // 0: ManyPostsResponse.posts:type_name -> PostResponse
	0, // 1: PostService.CreatePost:input_type -> PostRequest
	4, // 2: PostService.GetPosts:input_type -> Empty
	3, // 3: PostService.ToggleUpvote:input_type -> PostUserIdRequest
	1, // 4: PostService.CreatePost:output_type -> PostResponse
	2, // 5: PostService.GetPosts:output_type -> ManyPostsResponse
	1, // 6: PostService.ToggleUpvote:output_type -> PostResponse
...
func file_post_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_post_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PostUserIdRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
